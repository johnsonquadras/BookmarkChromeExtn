        ...
        execute: function() {
            ...
            BookmarkComponent = (function () {
                function BookmarkComponent() {
                    ...
                    this.bookmarkValidated = new core_3.EventEmitter();
                }
                ...
                BookmarkComponent.prototype.onVaidate = function (bookmark) {
                    this.bookmarkValidated.emit(bookmark);
                };
                __decorate([
                    core_2.Output(), 
                ...
                __decorate([
                    core_2.Output(), 
                    __metadata('design:type', core_3.EventEmitter)
                ], BookmarkComponent.prototype, "bookmarkValidated", void 0);
